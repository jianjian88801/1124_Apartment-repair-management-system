    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="改派原因" prop="gaipaiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="改派原因"
                  v-model="ruleForm.gaipaiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gaipaiyuanyin" label="改派原因" prop="gaipaiyuanyin">
                    <span>{{ruleForm.gaipaiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenqingshijian = true;
          ...
          if(o=='gaipaiyuanyin'){
            this.ruleForm.gaipaiyuanyin = obj[o];
	    this.ro.gaipaiyuanyin = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.weixiuxingming!=''&&json.weixiuxingming){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gaipaishenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gaipaishenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
