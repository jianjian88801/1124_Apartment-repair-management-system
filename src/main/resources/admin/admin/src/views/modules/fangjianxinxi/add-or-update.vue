<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="住户账号" prop="zhuhuzhanghao">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.zhuhuzhanghao" label="住户账号" prop="zhuhuzhanghao">
    ...
    zhuhuzhanghaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.shenfenzhenghao){
                this.ruleForm.shenfenzhenghao = data.data.shenfenzhenghao
              }
        } else {
          this.$message.error(data.msg);
        }
